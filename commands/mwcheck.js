...
module.exports = {
   ...
   async execute(message,args, cmd, client, Discord){
       ...
       try{
           ...
           .setDescription('Cod Modern Warfare Stats')
           .addFields(
               ...
               {name: 'Best Killstreak', value: data.lifetime.all.properties.recordKillstreak},
           ...
           message.channel.send('There was an error fetching this player!! Make sure to do !mwcheck username platform');
           throw error;
       }
    }
}